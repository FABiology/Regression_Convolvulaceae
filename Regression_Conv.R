...
exponencial <- nls(Richness.Total ~ a-b*exp(-c*Density.Total), data=regression, start=list(a=6, b=5, c=0.07438118))
...
{plot(Richness.Total ~ Density.Total, data=regression, xlab="Collection Density", ylab="Species Richness",las=1,cex=0.5)
exponencial2 <- nls(Richness.Total ~ a*(1-exp(-c*Density.Total)), data=regression, start=list(a=6, c=0.07438118))
